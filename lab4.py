...
def start(message):
    bot.reply_to(message, "Привет! Используй /register чтобы зарегистрироваться.")
...
def admin_users(message):
    ...
    bot.reply_to(message, reply or "Нет пользователей.")
...
def webhook():
    ...
    print("Incoming update:", json_data)  # Логируем в консоль
